...
int main(int argc, char** argv)
{
    ...
    unsigned int nbIterations = cimg_option("-n", 100, "Number of iterations");
    ...
    // Create algorithm
    AbstractAlgorithm* algo = new CodebookProbabilistic(input, neighborhoodSize, nbIterations, verbose, fileStats);
